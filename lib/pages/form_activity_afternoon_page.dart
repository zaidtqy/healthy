...
class FormActivityAfternoon extends StatefulWidget {
  const FormActivityAfternoon({Key? key}) : super(key: key);

  @override
  State<FormActivityAfternoon> createState() => _FormActivityAfternoonState();
}

class _FormActivityAfternoonState extends State<FormActivityAfternoon> {
  // form key
