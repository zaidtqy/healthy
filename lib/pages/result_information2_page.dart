...
class ResultInformation2 extends StatefulWidget {
  final HistoryInformModel informModel;

  const ResultInformation2({
    Key? key,
    required this.informModel,
  }) : super(key: key);

  @override
  State<ResultInformation2> createState() => _ResultInformationState();
}

class _ResultInformationState extends State<ResultInformation2> {
